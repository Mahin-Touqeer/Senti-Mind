  ...
  return (
    <div className="min-h-screen bg-gradient-to-br overflow-hidden from-slate-950 via-[#141A4B] to-slate-900 py-16 px-2  flex items-center justify-center">
      <div className="w-full max-w-3xl mx-auto rounded-2xl bg-[#181A3B]/80 backdrop-blur-md shadow-xl border border-purple-500/10 p-6 sm:p-12 relative">
        ...
        <button
          onClick={() => navigate(-1)}
          className="flex absolute items-center gap-2  sm:px-5 py-2  rounded-full sm:bg-gradient-to-r from-purple-500 to-pink-500 text-white font-medium sm:shadow hover:scale-102 sm:hover:shadow-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-purple-400 cursor-pointer "
        >
